...
const quirkyMessages = [
  {
    text: "Can't wait? Yeah, us neither.",
    joke: "Our developers are building so fast their keyboards are on fire. Local fire department has us on speed dial now.",
    followUp: "How long would YOU wait for something actually good?"
  },
  {
    text: "What's taking so long?!",
    joke: "Our lead dev fell down a CSS rabbit hole last Tuesday. We're sending a search party. Send snacks.",
    followUp: "Ever gotten lost in something technical at 2am? It's a vibe."
  },
  {
    text: "Is it ready yet? Now? How about now?",
    joke: "We're technically still in the 'ambitious timeline' phase of development. Which means: no.",
    followUp: "Are you the 'refresh every 30 seconds' type or the 'check once a day' type?"
  },
  {
    text: "Go on, refresh. I dare you.",
    joke: "Nothing new will appear. But the developers appreciate your enthusiasm. They cry a little less each time.",
    followUp: "How many times have you refreshed today? Be honest - we're not judging."
  },
  {
    text: "This suspense is killing me!",
    joke: "Our last launch checklist had 'pray it works' as the final item. We're professionals. Mostly.",
    followUp: "What's the last thing you were genuinely excited for?"
  },
  {
    text: "Soon™ - every dev's favorite word",
    joke: "We're operating on 'developer time' where 'done' is a suggestion and 'when it's ready' is the only honest deadline.",
    followUp: "Do you deliver early, on time, or 'I'll have it to you tomorrow' time?"
  },
  {
    text: "Building the future. Or at least the code.",
    joke: "Rome wasn't built in a day, but this website? We're aiming for a week. Give or take. Mostly give.",
    followUp: "What's something that took longer than expected but was worth it?"
  },
  {
    text: "Good things come to those who wait!",
    joke: "Unless you're waiting for npm to install. Then you're just in purgatory.",
    followUp: "What's the best thing you've ever waited for? Food doesn't count."
  },
  {
    text: "Pssst... want a sneak peek?",
    joke: "Just kidding! Our NDA is tighter than our server configs. And those actually work. Mostly.",
    followUp: "Are you the peek-at-presents-early type or the 'no peeking' purist?"
  },
  {
    text: "ETA: Whenever it's ready ¯\\_(ツ)_/¯",
    joke: "In our defense, 'almost done' in dev terms means anything from 'tomorrow' to 'two months.' We're optimists.",
    followUp: "Ever given an estimate that was... creative with the truth?"
  }
];
