...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[var(--onyx)] text-[var(--spectral-white)] relative overflow-x-hidden">
      ...
      {/* Hero Section with 3D Blacklight Reveal */}
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-center min-h-[70vh]">
            ...
            {/* Spacer for 3D canvas - removed old quantum field */}
